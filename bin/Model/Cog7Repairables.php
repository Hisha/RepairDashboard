...
class Cog7Repairables
{
    ...
    public function getTop10Worst()
    {
        ...
        ORDER BY
            CASE
                WHEN COALESCE(rep12.repair_actions_12m, 0) > 0 AND
                     (
                        CASE
                            WHEN COALESCE(rep12.repair_actions_12m, 0) > 0
                            THEN COALESCE(rep12.success_actions_12m, 0) / COALESCE(rep12.repair_actions_12m, 0)
            ...
            END,
            survival_12m ASC,
            repair_actions_12m DESC,
            s.last_ship_date DESC,
            l.niin ASC
        LIMIT 10
        ";
    ...
    ORDER BY trend_delta ASC  -- most negative = worst trend
    LIMIT 10
    ";
